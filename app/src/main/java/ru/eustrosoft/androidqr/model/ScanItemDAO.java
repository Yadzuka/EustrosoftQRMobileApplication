...
public class ScanItemDAO {
    private static ScanItemDAO sScanItemDAO;

    private Context mContext;
    private SQLiteDatabase mDatabase;

    private ScanItemDAO(Context context) {
        mContext = context.getApplicationContext();
        mDatabase = new ScanItemBaseHelper(mContext)
                .getWritableDatabase();
    }

    public static ScanItemDAO get(Context context) {
        if (sScanItemDAO == null)
            sScanItemDAO = new ScanItemDAO(context);
